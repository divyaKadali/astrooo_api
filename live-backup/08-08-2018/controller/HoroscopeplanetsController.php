  ...
  for($i=0; $i<count($navrearray);$i++){
   ...
   return $result;
    ...
    public function actionViewnew2($id)
    {
    	...
    	$result['moonsign']= $model[0]['rashiname'];
    	$result['rasi']=$model[0]['nakshatram'];
    	$bhavas['Self']=$bhavam[0];
    	$bhavas['Wealth']=$bhavam[1];
    	$bhavas['Family']=$bhavam[2];
    	$bhavas['Mother']=$bhavam[3];
    	$bhavas['Assets']=$bhavam[4];
    	$bhavas['Children']=$bhavam[5];
    	$bhavas['EnemiesDebt']=$bhavam[6];
    	$bhavas['Marriage']=$bhavam[7];
    	$bhavas['Health']=$bhavam[8];
    	$bhavas['Lucky_Father']=$bhavam[9];
    	$bhavas['Career']=$bhavam[10];
    	$bhavas['Savings']=$bhavam[11];
